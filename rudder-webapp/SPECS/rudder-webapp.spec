...
cp %{_sourcedir}/rudder-sources/rudder/rudder-core/src/main/resources/Migration/rudder-upgrade-LDAP-schema-2.3-2.4-PI-PT-CR-names-changed.pl %{buildroot}%{rudderdir}/share/upgrade-tools/
