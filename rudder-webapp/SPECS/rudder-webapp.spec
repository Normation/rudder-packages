...
cp %{_sourcedir}/rudder-sources/rudder/rudder-core/src/main/resources/Migration/dbMigration-2.11-3.0-add-insertionsids-column.sql %{buildroot}%{rudderdir}/share/upgrade-tools/
