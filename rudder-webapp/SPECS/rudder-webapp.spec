...
cp %{_sourcedir}/rudder-sources/rudder/rudder-core/src/main/resources/Migration/ldapMigration-2.10-2.11-add-root-server-role.ldif %{buildroot}%{rudderdir}/share/upgrade-tools/
