...
Requires: %(../format-dependencies rpm %{real_epoch}:%{real_version} rudder-agent), rsyslog, openssl, %{apache}, %{apache_tools}, python, binutils, xz
...
find /var/rudder/share -type d | xargs chmod 2750
