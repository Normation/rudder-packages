...
ps axf | grep "/var/rudder/cfengine-community/bin/cf" | grep -v "grep"
NB_CFE_PROCESS=`ps axf | grep "/var/rudder/cfengine-community/bin/cf" | grep -v "grep" | wc -l`
if [ ${NB_CFE_PROCESS} -gt 0 ]; then
