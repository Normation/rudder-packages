...
env="RUDDER_VERSION_TO_PACKAGE=${VERSION} USE_SYSTEM_OPENSSL=false USE_SYSTEM_ZLIB=false USE_SYSTEM_LMDB=false USE_SYSTEM_PCRE=false USE_SYSTEM_PERL=true USE_SYSTEM_FUSION=false USE_SYSTEM_CURL=false USE_SYSTEM_AUGEAS=false USE_SYSTEM_JQ=false USE_SYSTEM_YAML=false USE_SYSTEM_XML=false USE_ACL=false USE_PIE=false"
